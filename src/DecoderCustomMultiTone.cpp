...
DecoderCustomMultiTone::DecoderCustomMultiTone(const BeepingConfig& config,
  ...
  Globals::getIdxsFromIdxCustomMultiTone(idxFrontDoorToken1,
                                         &idxTonesFrontDoorToken1);
  idxTonesFrontDoorToken2 = new int[2];
  Globals::getIdxsFromIdxCustomMultiTone(idxFrontDoorToken2,
                                         &idxTonesFrontDoorToken2);

  mDecodingMode =
      Globals::/*DECODING_MODE::*/ DECODING_MODE_CUSTOM;  // 0=AUDIBLE,
                                                          // 1=NONAUDIBLE,
                                                          // 2=HIDDEN, 3=CUSTOM
  BTRACE(
...
DecoderCustomMultiTone::~DecoderCustomMultiTone(void) {
  BTRACE("DecoderCustomMultiTone::dtor");
  delete[] mFreqsBins;
  delete[] mIdxs;
...
int DecoderCustomMultiTone::AnalyzeStartTokens(
    float* audioBuffer) {  // float *magSpectrum, float* realSpectrum, float*
                           // imagSpectrum
  BTRACE("DecoderCustomMultiTone::AnalyzeStartTokens");
  ...
  while (getSizeFilledBlockCircularBuffer() >=
    ...
    for (int i = 0; i < (mSizeBlockCircularBuffer / 2); i++) {
      ...
      mBlockTokenStatistics[s].idxToken =
          Globals::getIdxTokenFromIdxsTonesCustomMultiTone(
...
int DecoderCustomMultiTone::ComputeStatsStartTokens() {
  BTRACE("DecoderCustomMultiTone::ComputeStatsStartTokens");
...
int DecoderCustomMultiTone::ComputeStats() {
  BTRACE("DecoderCustomMultiTone::ComputeStats");
  // energy mean in the alphabet frequency region
...
float DecoderCustomMultiTone::ComputeBlockMagSpecSumsLastToken(
...
float DecoderCustomMultiTone::ComputeBlockMagSpecSumsCurrentToken(
    int midFreqBin, int width, int nbins, std::vector<float>& sumPerFrame) {
  float mean = 0;
  float sumFr = 0;
