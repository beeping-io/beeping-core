...
float getFreqFromIdxAudible(int idx, float samplingRate, int windowSize) {
  ...
  int firstFreqBin = (int)(3300.f / binToHz + .5);  // first token arround
                                                    // 3300Hz

  float firstFreq = firstFreqBin * binToHz;

  int tokenDistanceInBins =
      (int)(210.f / binToHz + .5);  // separation between token arround 210Hz
...
float getFreqFromIdxNonAudible(int idx, float samplingRate, int windowSize) {
  ...
  int firstFreqBin =
      (int)(16800.f / binToHz + .5);  // first token arround 3300Hz
  ...
  // token arround 210Hz
  int tokenDistanceInBins =
      (int)(155.f / binToHz + .5);  // separation between token arround 200Hz
...
void getIdxsFromIdxAudibleMultiTone(int idx, int** idxtones) {
  switch (
      idx)  // http://www.estadisticaparatodos.es/software/misjavascript/javascript_combinatorio2.html
  {
    case 0:
      (*idxtones)[0] = 0;
      (*idxtones)[1] = 1;
...
int getIdxTokenFromIdxsTonesAudibleMultiTone(int idx1, int idx2) {
  if ((idx1 == 0) && (idx2 == 1))
    ...
    return 2;
  else if ((idx1 == 0) && (idx2 == 4))
    return 3;
  else if ((idx1 == 0) && (idx2 == 5))
    return 4;
  else if ((idx1 == 0) && (idx2 == 6))
    return 5;
  else if ((idx1 == 0) && (idx2 == 7))
    return 6;
  else if ((idx1 == 0) && (idx2 == 8))
    return 7;
    ...
    return 9;
  else if ((idx1 == 1) && (idx2 == 4))
    return 10;
  else if ((idx1 == 1) && (idx2 == 5))
    return 11;
  else if ((idx1 == 1) && (idx2 == 6))
    return 12;
  else if ((idx1 == 1) && (idx2 == 7))
    return 13;
  else if ((idx1 == 1) && (idx2 == 8))
    return 14;

  else if ((idx1 == 2) && (idx2 == 3))
    return 15;
  else if ((idx1 == 2) && (idx2 == 4))
    return 16;
  else if ((idx1 == 2) && (idx2 == 5))
    return 17;
  else if ((idx1 == 2) && (idx2 == 6))
    return 18;
  else if ((idx1 == 2) && (idx2 == 7))
    return 19;
  else if ((idx1 == 2) && (idx2 == 8))
    return 20;
    ...
    return 22;
  else if ((idx1 == 3) && (idx2 == 6))
    return 23;
  else if ((idx1 == 3) && (idx2 == 7))
    return 24;
  else if ((idx1 == 3) && (idx2 == 8))
    return 25;

  else if ((idx1 == 4) && (idx2 == 5))
    return 26;
  else if ((idx1 == 4) && (idx2 == 6))
    return 27;
  else if ((idx1 == 4) && (idx2 == 7))
    return 28;
  else if ((idx1 == 4) && (idx2 == 8))
    return 29;

  else if ((idx1 == 5) && (idx2 == 6))
    return 30;
  else if ((idx1 == 5) && (idx2 == 7))
    return 31;

  // reversed
  else if ((idx2 == 0) && (idx1 == 1))
    return 0;
  else if ((idx2 == 0) && (idx1 == 2))
    return 1;
  else if ((idx2 == 0) && (idx1 == 3))
    return 2;
  else if ((idx2 == 0) && (idx1 == 4))
    return 3;
  else if ((idx2 == 0) && (idx1 == 5))
    return 4;
  else if ((idx2 == 0) && (idx1 == 6))
    return 5;
  else if ((idx2 == 0) && (idx1 == 7))
    return 6;
  else if ((idx2 == 0) && (idx1 == 8))
    return 7;

  else if ((idx2 == 1) && (idx1 == 2))
    return 8;
  else if ((idx2 == 1) && (idx1 == 3))
    return 9;
  else if ((idx2 == 1) && (idx1 == 4))
    return 10;
  else if ((idx2 == 1) && (idx1 == 5))
    return 11;
  else if ((idx2 == 1) && (idx1 == 6))
    return 12;
  else if ((idx2 == 1) && (idx1 == 7))
    return 13;
  else if ((idx2 == 1) && (idx1 == 8))
    return 14;

  else if ((idx2 == 2) && (idx1 == 3))
    return 15;
  else if ((idx2 == 2) && (idx1 == 4))
    return 16;
  else if ((idx2 == 2) && (idx1 == 5))
    return 17;
  else if ((idx2 == 2) && (idx1 == 6))
    return 18;
  else if ((idx2 == 2) && (idx1 == 7))
    return 19;
  else if ((idx2 == 2) && (idx1 == 8))
    return 20;

  else if ((idx2 == 3) && (idx1 == 4))
    return 21;
  else if ((idx2 == 3) && (idx1 == 5))
    return 22;
  else if ((idx2 == 3) && (idx1 == 6))
    return 23;
  else if ((idx2 == 3) && (idx1 == 7))
    return 24;
  else if ((idx2 == 3) && (idx1 == 8))
    return 25;

  else if ((idx2 == 4) && (idx1 == 5))
    return 26;
  else if ((idx2 == 4) && (idx1 == 6))
    return 27;
  else if ((idx2 == 4) && (idx1 == 7))
    return 28;
  else if ((idx2 == 4) && (idx1 == 8))
    return 29;

  else if ((idx2 == 5) && (idx1 == 6))
    return 30;
  else if ((idx2 == 5) && (idx1 == 7))
    return 31;

  else
    return -1;  // check if this makes sense!
}
  ...
  */
      ...
      idx)  // http://www.estadisticaparatodos.es/software/misjavascript/javascript_combinatorio2.html
  {
    case 0:
      (*idxtones)[0] = 0;
      (*idxtones)[1] = 1;
      break;  // commented for more distance between freqs
...
void getFreqsFromIdxAudibleMultiTone(int idx, float samplingRate,
  ...
  /* idxtone1 = idx / 2;
   freqs[0] = getToneFromIdxAudibleMultiTone(idxtone1, samplingRate,
   windowSize); idxtone2 = (idx + numTonesAudibleMultiTone) %
   numTonesAudibleMultiTone; freqs[1] = getToneFromIdxAudibleMultiTone(idxtone2,
  ...
  (*freqs)[0] =
      getToneFromIdxAudibleMultiTone(idxs[0], samplingRate, windowSize);
  (*freqs)[1] =
      getToneFromIdxAudibleMultiTone(idxs[1], samplingRate, windowSize);
...
float getToneFromIdxAudibleMultiTone(int idx, float samplingRate,
                                     int windowSize) {
  float binToHz =
      samplingRate / windowSize;  // 21,5332Hz for 1 bin at 44100Hz-2048ws
  ...
  int firstFreqBin =
      (int)(3300.f / binToHz +
            .5);  // first token arround 3300Hz, last token arround 10080Hz

  float firstFreq = firstFreqBin * binToHz;

  int tokenDistanceInBins =
      (int)(750.f / binToHz +
            .5);  // separation between tokens arround 750Hz, we need to fit 9
                  // tones between 3.3Khz and 11Khz
...
float getToneFromIdxNonAudibleMultiTone(int idx, float samplingRate,
  ...
  // int tokenDistanceInBins = (int)(580.f / binToHz + .5); //separation between
  // tokens arround 580Hz, we need to fit 9 tones between first and last bin int
  ...
  // int tokenDistanceInBins = (int)(210.f / binToHz + .5); //separation between
  // token arround 210Hz int tokenDistanceInBins = (int)(155.f / binToHz + .5);
  // //separation between token arround 200Hz
...
float getToneFromIdxHiddenMultiTone(int idx, float samplingRate, int windowSize,
  ...
  // 17807.9Hz, last token arround 21425Hz
  int firstFreqBin =
      (int)(14000.f / binToHz + .5);  // first token arround 18001.75Hz, last
  ...
  int tokenDistanceInBins =
      (int)(freqOffset * 3.f / binToHz +
            .5);  // separation between tokens arround ~387Hz, we need to fit 10
                  ...
                  // arround 210Hz int tokenDistanceInBins = (int)(155.f /
                  // binToHz + .5); //separation between token arround 200Hz
...
void getLoudnessAudibleMultiToneFromIdx(int idx, float** freqsLoudness) {
  ...
  // apply a log scale attenaution for high freqs
  float maxAttdB = -6.f;
  (*freqsLoudness)[0] = powf(
      10.f, maxAttdB *
                (1 - ((float)idxs[0] / (float)(numTonesAudibleMultiTone - 1))) /
                20.f);
  (*freqsLoudness)[1] = powf(
      10.f, maxAttdB *
                (1 - ((float)idxs[1] / (float)(numTonesAudibleMultiTone - 1))) /
                20.f);
...
void getLoudnessNonAudibleMultiToneFromIdx(int idx, float** freqsLoudness) {
  ...
  // apply a log scale attenaution for high freqs
  // float maxAttdB = -6.f;
  //(*freqsLoudness)[0] = powf(10.f, maxAttdB * (1 - ((float)idxs[0] /
  //(float)(numTonesNonAudibleMultiTone - 1))) / 20.f);
  //(*freqsLoudness)[1] = powf(10.f, maxAttdB * (1 - ((float)idxs[1] /
  //(float)(numTonesNonAudibleMultiTone - 1))) / 20.f);

  // Apply linear attenuation to lower freqs
  (*freqsLoudness)[0] =
      0.85f + 0.15f * (float)idxs[0] / (float)(numTonesNonAudibleMultiTone - 1);
  (*freqsLoudness)[1] =
      0.85f + 0.15f * (float)idxs[1] / (float)(numTonesNonAudibleMultiTone - 1);
...
void getLoudnessHiddenMultiToneFromIdx(int idx, float** freqsLoudness) {
  ...
  // Apply linear attenuation to lower freqs
  (*freqsLoudness)[0] =
      0.85f + 0.15f * (float)idxs[0] / (float)(numTonesHiddenMultiTone - 1);
  (*freqsLoudness)[1] =
      0.85f + 0.15f * (float)idxs[1] / (float)(numTonesHiddenMultiTone - 1);
...
void getLoudnessCustomMultiToneFromIdx(int idx, float** freqsLoudness) {
  ...
  // Apply linear attenuation to lower freqs
  (*freqsLoudness)[0] =
      0.85f + 0.15f * (float)idxs[0] / (float)(numTonesCustomMultiTone - 1);
  (*freqsLoudness)[1] =
      0.85f + 0.15f * (float)idxs[1] / (float)(numTonesCustomMultiTone - 1);
...
float secondValue(float* myArray, int size) {
  ...
  if (maxValIdx == 0) secondValue = myArray[1];

  for (i = 0; i < size; i++)
    if (i != maxValIdx)
      if (myArray[i] > secondValue) secondValue = myArray[i];
...
float square_sum(float* data, int size) {
  ...
  for (int i = 0; i < size; ++i) square_sum += powf(data[i], 2.f);
  return square_sum;
}
